...
export const invitationConfig: InvitationConfig = {
  ...
  event: {
    targetIsoDate: '2026-09-11T19:00:00+03:30',
    persianDateText: 'جمعه ۲۱ شهریور ۱۴۰۵',
    weddingDayText: 'جمعه ۲۱ شهریور ۱۴۰۵',
  ...
  media: {
    ...
    gallery: [
      ...
      {
        id: '3',
        src: '/images/Outdoor_duo.jpg',
        title: 'هم‌قدم در مسیر زندگی',
        caption: 'با حضورتان گرمی‌بخش آغاز این راه باشید',
      },
    ],
  },
  story: {
